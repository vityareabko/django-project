...
class Topic(models.Model):
    ...
    board = models.ForeignKey(Board, related_name='topics', on_delete=models.CASCADE, null=True)
    starter = models.ForeignKey(User, related_name='topics', on_delete=models.CASCADE, null=True)
